// Klo Udah Di Kasih Free Minimal Nama Yutup itsmekay Ditaruh Yah :)
...
xavior.sendMessage(m.chat, {audio: goblok, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
 xavior.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `XaviorV2.zip`}, {quoted:m})}
            ...
            ana = fs.readFileSync('./Xavior.json')
              m.reply('*Woe Bre Minimal Subscribe Yt itsmekay Lah*')
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nContoh : ${prefix + command} Subscribe Yt itsmekay`
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            case 'okay': { m.reply('Subrek lah Yt itsmekay')} break
